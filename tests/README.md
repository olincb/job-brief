...
- `test_*.py`: one module per concern. Condense, the Markdown renderer, the
  heartbeat rule, and fetching (one fetcher against a recording, title filters,
  dedup against the Seen tab).
